...
public class ExemploMatriz {
	...
	public static void main(String[] args) {
		...
		System.out.println("Listar os daos Matriz Numeros");
		...
		for (int linha = 0; linha < numerosReais.length; linha++) {
			...
			System.out.println("Tamanho da Matriz Numeros Reais[0]" + numerosReais.length);

			for (int linha = 0; linha < numerosReais.length; linha++) {

				for (int coluna = 0; coluna < numerosReais[linha].length; coluna++) {
					System.out.printf("numerosReais [%d][%d] = %f%n", linha, coluna, numerosReais[linha][coluna]);
